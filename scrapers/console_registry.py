...
CONSOLES: tuple[Console, ...] = (
    ...
    Console(
        ...
        variants=("ps5", "ps5-digital", "ps5-slim"),
        notes="Sony reports the PS5 family as a single combined total (standard, Digital Edition, Slim, Pro). See the separate PS5 Pro page for launch-specific context.",
        wikipedia_article="PlayStation_5",
    ),
    Console(
        slug="ps5-pro",
        display_name="PlayStation 5 Pro",
        manufacturer="Sony",
        generation="current",
        form_factor="home",
        launch_date="2024-11-07",
        variants=("ps5-pro",),
        notes="Sony does not break out PS5 Pro unit sales separately; they are included in the PlayStation 5 family total. This page exists for launch-date and model context.",
        wikipedia_article="PlayStation_5_Pro",
    ),
    Console(
        slug="xbox-series",
